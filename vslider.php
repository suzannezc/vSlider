...
/*
	Plugin Name: vSlider
	Plugin URI:
	Description: Add slides to your homepage slider for your school!
	Author: MR.Vibe, modified by Suzanne Carter (WRDSB)
	Version: 4.1.2
	Author URI:
...
function vslider_head($option) { 
	...
	<!-- Start vSlider javascript options -->
	...
	#<?php echo $option; ?> .cs-title { 
		...
		case 'stripe-top':{
		echo 'top:0; height: '.($options['height']/2 -50).'px;width: '.($options['width']-$options['borderWidth']+10).'px; padding: 10px;overflow:hidden;';
		break;
		}
		case 'stripe-right':{ $width=$options['width']/3+$options['borderWidth']-10;
		echo 'margin-left: '.($options['width']-$width).'px;top: 0;width: '.($width).'px; padding: 10px 10px 0 10px;';
		break;
		}
		case 'stripe-bottom':{
		...
		case 'stripe-left':{
		echo 'left:0;top:0;width: '.($options['width']/3+$options['borderWidth']-10).'px; padding: 10px 10px 0 10px;';
		break;
		}
		}?>
	}
	...
	#<?php echo $option; ?>container .cs-buttons {
		clear:both; 
		font-size: 0; 
		margin: <?php echo $options['navplace']; ?>; 
		float: left; 
	}
 
	#cs-button-<?php echo $option; ?>{ 
		z-index:999;
		outline:none;
	}
	...
	#<?php echo $option; ?>container .cs-buttons a { 
		margin-left: 5px; 
		height: 5px; 
		width: 5px; 
		float: left; 
	...
	#<?php echo $option; ?>container a.cs-active { 
		background-color: #<?php echo $options['textColor']; ?>; 
		outline: none !important;
	}	
	...
	#<?php echo $option; ?>container .cs-buttons a:hover, #<?php echo $option; ?>container a.cs-active { 
		background: url('<?php echo WP_CONTENT_URL;?>/plugins/vslider/images/nav_style1.png') no-repeat;
	...
	#<?php echo $option; ?>container .cs-buttons a:hover, #<?php echo $option; ?>container a.cs-active { 	
		background: url('<?php echo WP_CONTENT_URL;?>/plugins/vslider/images/nav_2_active.png') no-repeat; 
		outline: none !important;
	}	
	<?php break;
	}
	...
	#<?php echo $option; ?>container .cs-buttons a { 
		...
		width: 15px; 
		float: left; 
		background: url('<?php echo WP_CONTENT_URL;?>/plugins/vslider/images/default_style.png') no-repeat;
		background-position:top;
		text-indent: -1000px;
		outline: none !important;
		<?php if($options['vnavenable']) {
	...
	case 'arr_style1':{ ?>
	#<?php echo $option; ?>	.cs-prev {
		margin-left:8px; 
		line-height: 50px;
		width: 50px;
		height:50px; 
		background: url('<?php echo WP_CONTENT_URL;?>/plugins/vslider/images/nav_style1_arrows-prev.png')no-repeat; 
		text-indent: -999px;
	}

	#<?php echo $option; ?>	.cs-next {
		margin-right: 5px; 
		line-height: 50px;
		width: 50px;
		height:50px; 
		background: url('<?php echo WP_CONTENT_URL;?>/plugins/vslider/images/nav_style1_arrows-next.png')no-repeat; 
		text-indent: -999px;
	}
	<?php break;
	}
	...
	#<?php echo $option; ?>	.cs-prev {
		...
		width: 30px;
		height:30px; 
		background: url('<?php echo WP_CONTENT_URL;?>/plugins/vslider/images/nav_style2_arrows-prev.png')no-repeat; 
		text-indent: -999px;
	}
	#<?php echo $option; ?>	.cs-next {
		margin-right: 5px; 
		...
		width: 30px;
		height:30px; 
		background: url('<?php echo WP_CONTENT_URL;?>/plugins/vslider/images/nav_style2_arrows-next.png')no-repeat; 
		text-indent: -999px;
	}
	<?php 
	break;
	...
	#<?php echo $option; ?>	.cs-prev {
		...
		width: 50px;
		height:50px; 
		background: url('<?php echo WP_CONTENT_URL;?>/plugins/vslider/images/nav_style3_arrows-prev.png')no-repeat; 
		text-indent: -999px;
	}
	#<?php echo $option; ?>	.cs-next {
		margin-right: 5px; 
		...
		width: 50px;
		height:50px; 
		background: url('<?php echo WP_CONTENT_URL;?>/plugins/vslider/images/nav_style3_arrows-next.png')no-repeat; 
		text-indent: -999px;
	}
	<?php
	break;
	...
	default:{?>
	#<?php echo $option; ?>	.cs-prev, #<?php echo $option; ?> .cs-next {
		font-weight: bold;
		background: #<?php echo $options['bgColor']; ?> !important;
